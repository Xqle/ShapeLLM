...
from llava.mm_utils import load_pts, process_pts, rotation, tokenizer_point_token
...
def CustomDPODataCollator(DPODataCollatorWithPadding):
    def __init__(self, data_args, *args, **kwargs):
        super(CustomDPODataCollator, self).__init__(*args, **kwargs)
        self.data_args = data_args
