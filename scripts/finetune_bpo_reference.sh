MODEL_NAME=ShapeLLM_13B_gapartnet
TAG=bpo
date=$(date +%m%d%H%M)

# echo $date'_'$MODEL_NAME'_'$TAG

deepspeed --include localhost:0,1,2,3 llava/train/train_bpo_reference.py \
    ...
    --version v1 \
    --data_path ./playground/data/shapellm/gapartnet_bpo_5k_error_injection.json \
